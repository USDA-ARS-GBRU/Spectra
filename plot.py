...
def execute(args):
    ...
    # (sequencePanda['Start'][0] + sequencePanda['End'][0]) / 2
    sequencePanda = sequencePanda.melt(id_vars=['Library', 'Sequence', 'Start', 'End'], value_vars=sequencePanda.columns[-64:]) # this renames the combined column to variable and the counts to value
